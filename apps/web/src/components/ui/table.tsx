...
// Todos os subcomponentes de Table usam forwardRef explícito — mesmo motivo
// do fix em Input/Dialog/Button/Card/Checkbox/Label/Select: preset
// radix-nova assume o modelo de ref-como-prop do React 19, projeto está no
// React 18. A ref de `Table` aponta pro <table> em si (não pro <div>
// wrapper de overflow), convenção padrão do componente.
